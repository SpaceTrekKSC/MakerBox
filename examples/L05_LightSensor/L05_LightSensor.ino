/************************************************* *************************************************
* MakerBox Lesson 5:  Light Sensor
* In this lesson you will learn how to use the ambient light sensor. It is a photo-resistor which 
...
#include <MakerBoxLightSensor.h>              //include the light sensor library
